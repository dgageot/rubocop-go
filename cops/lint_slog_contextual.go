...
// NewLintSlogContextual enforces that callers use the *Context variant of every
...
func NewLintSlogContextual(opts ...cop.FuncOption) *cop.Func {
	return configuredFileCop(&cop.Func{
		Meta: cop.Meta{
			Name:        "Lint/SlogContextual",
			Description: "Use contextual slog calls when a context is available.",
